...
static constexpr auto qt_meta_stringdata_CLASSBaseWindowENDCLASS = QtMocHelpers::stringData(
    "BaseWindow",
    "windowClosed",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSBaseWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSBaseWindowENDCLASS_t qt_meta_stringdata_CLASSBaseWindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "BaseWindow"
...
void BaseWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &BaseWindow::windowClosed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
